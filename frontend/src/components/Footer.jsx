    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">AirTicket</span>
            </div>
            <p className="text-gray-400 mb-4">
              Book your flights with ease and enjoy a seamless travel experience. 
              We offer the best prices and most convenient routes to destinations worldwide.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 AirTicket. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
